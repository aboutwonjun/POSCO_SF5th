...
void editStudentInfo(vector<string>& name, vector<int>& age, vector<int>& birth_year, vector<int>& birth_month, vector<int>& birth_day, int student_num) {
    int editStudentNum;
    ...
    while (true) 
        {
        if (editStudentNum <= 0 || editStudentNum > student_num) 
            {
